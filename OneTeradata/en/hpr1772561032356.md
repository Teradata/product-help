After indexing, you query the vector store to retrieve relevant data. The system compares your query to stored vectors and returns top k matches. The results can be improved by changing the settings:
...
Select Euclidean, or Cosine, or Dot product.
