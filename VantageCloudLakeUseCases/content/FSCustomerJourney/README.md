...
Click [Load Assets](#data={"id":"FSCustomerJourney"}) to create the tables and load the data required into your account (Teradata database instance) for this use case.
