...
Select **Load Assets** to create the tables and load the data required into your account (Teradata database instance) for this use case. [Load Assets](#data=%7B%22id%22:%22EVCarBattery%22%7D)
...
After running this query, it looks like we have an issue with part\_no 20rd0.
...
**bom** - Bill of materials - Contains all major parts that make up each vehicle:
...
**mfg\_plants** - Manufacturing facilities:
...
**parts** - Master list of parts for all vehicles:

-   `part_no`: unique part number
-   `description`: part description

**vehicles** - Vehicles we have built/are building:
