As DS_ADMIN, add other database users as share citizen and providers in the data sharing ecosystem, so that these users can create, share, and view data throught shares.
