...
**Importante:** La región, el tamaño de [clúster principal](isb1696461636881.md) y el [unidades consumidas](onj1682104977691.md) valor de real tienen un efecto sobre el coste. A medida que cambia la configuración del entorno, el panel [Estimaciones de consumo](aow1703107228725.md) actualiza automáticamente el uso proyectado y cualquier exceso con los cambios.
