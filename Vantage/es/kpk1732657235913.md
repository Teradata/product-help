1.  En el cuadro de mando de ModelOps, seleccione el proyecto > **Ingeniería de características** > una tarea > **Desplegar**.
...
1.  Complete los campos de la pestaña **Publicar** y seleccione **Siguiente**:
    ...
    -   En la pestaña **Publicar**, seleccione la conexión de conjunto de datos para la tarea. En las **opciones avanzadas**, seleccione el **nombre del motor** y la **imagen de Docker**.


1.  Complete los campos de la pestaña **Publicar**:
...
1.  Seleccione **Desplegar**.
    ...
    **Detalles del despliegue** muestra la información de los registros para la tarea. Puede **detener** (poner en pausa) el progreso.
