...
1.  [Opcional] Use la sección **Opciones avanzadas** para especificar la cantidad de [Espacio permanente](yvc1731523611301.md) y [Juego de caracteres](hnk1731523638342.md) para el DBA.


1.  [Opcional] Seleccione **Mostrar SQL** para ver los privilegios asignados antes de crear el usuario administrador de base de datos.
