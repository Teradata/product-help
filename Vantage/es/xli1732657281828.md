...
1.  En el cuadro de mando de ModelOps, seleccione el proyecto > **Trabajos** > un trabajo > ![menú de tres puntos.](Images/kbt1547502809538.png) > **Ver detalles**.

    Seleccione **Detener** para cancelar cualquier trabajo que esté en curso.


1.  Para ver los detalles de un evento, seleccione ![menú de tres puntos.](Images/kbt1547502809538.png) > **Ver detalles**.
