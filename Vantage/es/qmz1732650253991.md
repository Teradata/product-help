...
1.  En la pestaña **Conexiones**, seleccione ![Menú de tres puntos verticales](Images/zsz1597101912145.svg) > **Ver detalles** para una conexión.

    Algunos ejemplos de errores incluyen funciones que no sirven para una versión de base de datos específica y problemas de permisos de instrucciones SQL.
