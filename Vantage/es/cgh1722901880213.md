...
1.  Seleccione el entorno de destino en el menú **Seleccione el entorno de VantageCloud Lake** y, posteriormente, seleccione **Siguiente**.
...
1.  Seleccione **Iniciar diagnósticos** para ejecutar la prueba y espere a que se complete antes de seleccionar **Siguiente**.
