...
1.  Complete los campos:
    ...
    -   Asigne a la conexión de conjunto de datos un **nombre** y una **descripción** significativos.
    ...
    -   Para **Credenciales**, especifique el **nombre de usuario** y la **contraseña**.


1.  [Opcional] Seleccione **Probar conexión**.


1.  Seleccione **Guardar**.


1.  Para establecer una conexión de conjunto de datos personal diferente como predeterminada, seleccione ![Menú de tres puntos verticales](Images/zsz1597101912145.svg) > **Establecer como predeterminado**.
