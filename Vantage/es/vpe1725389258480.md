...
1.  [Optional] Seleccione **Probar conexión**.


1.  Seleccione **Guardar**.


1.  Para establecer una conexión de conjunto de datos personal diferente como predeterminada, seleccione ![menú de tres puntos](Images/zsz1597101912145.svg) > **Establecer como predeterminado**.
