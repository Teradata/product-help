...
-   **Anular bloqueo de acceso**
    ...
    Solo para trabajos de Teradata-to-Teradata, puede seleccionar esta opción para permitir actualizaciones en la tabla de origen al copiar en el destino. Úselo con precaución, existe el riesgo de copiar a la tabla de destino datos que aún no se han confirmado en la tabla de origen.
