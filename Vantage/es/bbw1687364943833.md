...
-   **Cuenta de servicio con objeto de autorización: DEFINER**
    ...
    Requiere la creación de una cuenta de servicio en el origen de datos de destino. Las credenciales de inicio de sesión se almacenan en un objeto de autorización en el sistema iniciador en 
        `
 td_server_db
 `
...
-   **Objeto de autorización: INVOKER**
    ...
    Cree un objeto de autorización en cada base de datos de los usuarios de inicio que coincida con el nombre del objeto de autorización creado en 
        `
 td_server_db
 `
      . Las credenciales en el objeto de autorización para el usuario que inicia se recogen y pasan al origen de datos de destino para iniciar sesión al momento de la consulta.
