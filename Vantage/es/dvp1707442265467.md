...
1.  En los detalles de la solicitud, introduzca 
    `
 "Objetivo: Crear un endpoint de enlace privado de VantageCloud Lake para la copia de datos"
 `
...
1.  En los detalles de la solicitud, introduzca 
    `
 "Objetivo: Solicitar la creación de un endpoint de enlace privado de VantageCloud Lake para la copia de datos"
 `
...
1.  Proporcione la dirección del endpoint privado de la nube pública cuando se le solicite durante el proceso de **Conectar entorno** de copia de datos.
