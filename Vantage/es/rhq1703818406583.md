...
Verifique que PrivateLink esté conectado ejecutando *tping -p 19092 dbinterceptor-broker* en el sistema de destino.
...
No. No puede exportar la configuración. Una vez realizada una desinstalación del gestor de copias en el sistema de origen, la información no se puede recuperar. Todas las configuraciones y los recursos se eliminan de VantageCloud Lake.
