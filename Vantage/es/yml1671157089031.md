...
1.  En los detalles de la solicitud, introduzca 
    `
 "Objetivo: Solicitar la creación de un endpoint de enlace privado de VantageCloud Lake para QueryGrid"
 `
...
1.  En los detalles de la solicitud, introduzca 
    `
 "Objetivo: Solicitar la creación de un endpoint de enlace privado de VantageCloud Enterprise para *nombre de la característica*"
 `
