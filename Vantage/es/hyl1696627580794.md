...
1.  Una vez agregado como una cuenta de confianza en VantageCloud Lake Console, seleccione el grupo de recursos en Azure Portal para alojar el endpoint. Utilícelo para conectarse a un recurso de Azure mediante **ID de recurso** o **Alias**. Aquí es donde pega el nombre del servicio desde VantageCloud Lake Console.
...
1.  Una vez creado, copie el ID privado del endpoint como **Nombre de DNS** en VantageCloud Lake Console.
