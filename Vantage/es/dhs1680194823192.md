...
**Nota:** Es posible que su proveedor de identidad SAML requiera metadatos actualizados del proveedor de servicios (SP) de VantageCloud Lake. De ser así, después de agregar el proveedor en VantageCloud Lake, edítelo y seleccione **Exportar metadatos de proveedor de servicios (SP)**.
