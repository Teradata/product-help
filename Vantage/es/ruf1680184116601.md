...
Vantage crea un [dominio de entorno](jbj1680184191443.md) automáticamente para el primer proveedor de identidad que configure. dominio de **Predeterminado** entorno Es el dominio de entorno , pero puede cambiarle el nombre. Estándar Se pueden crear dominios adicionales.

Un proveedor de identidad debe tener al menos un dominio de entorno. Un dominio de entorno consta de uno o más [entornos](sbt1640280496980.md)de VantageCloud Lake.
