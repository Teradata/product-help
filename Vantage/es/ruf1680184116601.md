...
Vantage crea un [dominio de entorno](jbj1680184191443.md) automáticamente para el primer proveedor de identidad que configure. Es el dominio de entorno **Predeterminado**, pero puede cambiarle el nombre. Se pueden crear dominios adicionales.

Un proveedor de identidad debe tener al menos un dominio de entorno. Un dominio de entorno consta de uno o más de VantageCloud Lake [entornos](sbt1640280496980.md). Un entorno puede estar solamente en un dominio.
