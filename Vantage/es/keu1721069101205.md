...
[AWS solamente] Seleccione el tipo de almacenamiento para el clúster principal en su entorno:
...
Puede cambiar manualmente a **SSD de IOPS aprovisionadas** si tiene menos de 10 nodos, pero no puede cambiar a **SSD de finalidad general** si tiene más de 9 nodos. Al cambiar se verá afectado el precio y se reflejará en el panel **Estimaciones de consumo**.
