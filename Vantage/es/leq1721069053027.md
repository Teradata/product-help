...
**Consejo:** Después de crear el entorno, utilice grupos computacionales para proporcionar recursos computacionales a departamentos o proyectos específicos. Consejo: Gracias a la creación de grupos computacionales, puede gestionar la capacidad computacional mediante la creación de perfiles computacionales para escalar diferentes cargas de trabajo. Consulte [Recursos computacionales](nmr1658424425362.md).
