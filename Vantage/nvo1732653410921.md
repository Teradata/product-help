The Jobs tab displays the statistics of the scheduler performing various operations. This tab is not displayed if the Enable scheduling option was cleared when you deployed the model.
