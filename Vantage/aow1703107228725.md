...
-   **Term**
    ...
    Contracted period of time for your company.


-   **Committed units**

    Total units available in the contracted term.


-   **Spent**

    Units already consumed in the term by existing environments and compute clusters.


-   **Already allocated**

    Units projected to be used in the term for existing environments and compute clusters.


-   **New spend**

    Units projected to be used in the term for the new environment based on the values entered.


-   **Remaining**

    The projected remaining units for adding additional environments and compute clusters. If negative, you are now paying for units on a month-to-month basis.
