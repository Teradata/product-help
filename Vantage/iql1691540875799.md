Use the in-database analytics functions explorer (![""](Images/iug1692136295838.svg)) in Editor to quickly learn about preloaded functions and build queries with them. No coding is required.
