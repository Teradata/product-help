...
A private link service endpoint provides the connection between VantageCloud Lake and VantageCloud Lakeor a trusted AWS or Azure account. Cross-platform connectivity is not supported.
