Data Scientists and AI Engineers can use the **Feature engineering** option to run and schedule data preparation tasks with Python scripts before running a model.
