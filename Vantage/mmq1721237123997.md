Database administrators (DBAs) keep the database at peak performance, and make sure that the data is secure and protected. DBAs are database users who perform a variety of administrative tasks.
