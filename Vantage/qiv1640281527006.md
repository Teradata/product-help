...
1.  Complete **Site Configuration** with the following considerations:
    ...
    -   **Instance size**: The size of each node in the primary cluster. This size determines the number of units available for consumption per instance per hour. Select the best size, to opimize costs, for your compute and resource needs.
