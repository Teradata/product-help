...
|コネクタ|接続先|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on AWS (PrivateLink変更リクエストが必要)|
|Teradata-to-Teradata|VantageCloud Enterprise on AWS (PrivateLink変更リクエストが必要)|
...
|コネクタ|接続先|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on Azure (PrivateLink変更リクエストが必要)|
|Teradata-to-Teradata|VantageCloud Enterprise on Azure (PrivateLink変更リクエストが必要)|
|Teradata-to-Teradata|VantageCore (オンプレミス)|
...
|コネクタ|接続先|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on Google Cloud (プライベート サービス接続変更リクエストが必要)|
|Teradata-to-Teradata|VantageCloud Enterprise on Google Cloud (プライベート サービス接続変更リクエストが必要)|
|Teradata-to-Teradata|VantageCore (オンプレミス)|
