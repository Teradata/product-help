...
1.  Do one of the following:
    ...
    -   To save a model without importing model versions, select **Save model** > **Save model**. You can import versions at a later time. See [Import BYOM](nro1732650484867.md) or [Import Python model](jbg1732650538946.md).
...
1.  Set the properties based on the selected format.
    ...
    For properties information, see [Import BYOM](nro1732650484867.md) or [Import Python model](jbg1732650538946.md).
