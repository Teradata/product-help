...
1.  Wenn Sie Zugriff auf ein beliebiges [Computing-Gruppen](mqu1640280532737.md) erhalten haben, können Sie dasjenige auswählen, auf das Sie Ihre Abfrage anwenden möchten. Wenn Sie keine Computing-Gruppe auswählen, wird Ihre Abfrage auf das [primärer Cluster](nmr1658424425362.md) angewendet.
