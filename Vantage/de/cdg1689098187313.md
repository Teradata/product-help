...
|Stellt Verbindung her zu|Mit Verbindung|
|------------|---------------|
...
-   Während die QueryGrid-Bereitstellung vollständig automatisiert ist, ist das Löschen von QueryGrid-Ressourcen nicht als Self-Service verfügbar. Erstellen Sie eine Änderungsanforderung auf [https://support.teradata.com](https://support.teradata.com), um QueryGrid-Dienste zu löschen.
