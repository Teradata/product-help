...
-   **Verfügbarkeit**
    ...
    Wählen Sie **Im Zeitplan** beim Erstellen eines Profils oder aktivieren Sie **Zeitplan** beim Bearbeiten eines Profils, um festzulegen, wann ein Profil aktiv ist. Ohne einen Zeitplan ist ein Profil **Immer** aktiv.
