...
Als Organisationsadministrator oder Computing-Gruppenadministrator wählen Sie eine [Computing-Profile verwalten](dvl1640281718303.md)aus, wann immer Sie **Instanzgröße**. Dies ist die Anzahl an Knoten in jedem Computing-Cluster. Sie wählen zudem eine **Anzahl der Instanzen**aus, die Anzahl an Computing-Clustern.
