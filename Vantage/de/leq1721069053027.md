...
**Tipp:** Nachdem Sie Ihre Umgebung erstellt haben, verwenden Sie Computing-Gruppen, um bestimmten Abteilungen oder Projekten Computing-Ressourcen zur Verfügung zu stellen. Mit der Erstellung von Computing-Gruppen können Sie die Computing-Kapazität verwalten, indem Sie Computing-Profile für die Skalierung verschiedener Arbeitslasten erstellen. Siehe [Computing-Ressourcen](nmr1658424425362.md).
