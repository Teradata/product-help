...
1.  Geben Sie in den Anforderungsdetails Folgendes ein: 
    `
 „Zweck: Einen Endpunkt für privaten Link in VantageCloud Lake für Datenkopie erstellen“
 `
...
1.  Geben Sie in den Anforderungsdetails Folgendes ein: 
    `
 „Zweck: Anforderung zur Erstellung eines privaten Links in VantageCloud Enterprise für Datenkopie“
 `
   und geben Sie die folgenden Informationen an:
