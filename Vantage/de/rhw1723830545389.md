...
1.  [Optional] Verwenden Sie den Abschnitt **Erweiterte Optionen**, um die Menge an [Dauerhafter Speicher](yvc1731523611301.md) und [Zeichensatz](hnk1731523638342.md) für die Umgebung anzugeben. Wenn Sie keine Werte für den Platz und Zeichen eingeben, werden Systemstandardwerte verwendet.


1.  [Optional] Wählen Sie **SQL auswählen** aus, um die zugewiesenen Berechtigungen anzuzeigen, bevor der Datenbank-Administratorbenutzer erstellt wird. Dieser Bildschirm ist nur zur Ansicht verfügbar.
