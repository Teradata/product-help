...
|Verbindung|Stellt Verbindung her zu|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on AWS (erfordert eine PrivateLink-Änderungsanforderung)|
|Teradata-to-Teradata|VantageCloud Enterprise on AWS (erfordert eine PrivateLink-Änderungsanforderung)|
...
|Verbindung|Stellt Verbindung her zu|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on Azure (erfordert eine PrivateLink-Änderungsanforderung)|
|Teradata-to-Teradata|VantageCloud Enterprise on Azure (erfordert eine PrivateLink-Änderungsanforderung)|
|Teradata-to-Teradata|VantageCore (lokal)|
