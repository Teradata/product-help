Der *Schlummermodus* unterbindet zeitweise die Benachrichtigungen für eine aktive Warnung. Nach Ablauf der Schlummerperiode wird der Warnungsstatus wieder aktiv.

1.  Wählen Sie aus dem ModelOps-Dashboard das Projekt > **Warnungen** > die Warnung mit der Modellversions-Warnung, die Sie in den Schlummermodus versetzen möchten > ![Kebab-Menü](Images/kbt1547502809538.png) > **Details anzeigen**.


1.  Um alle Warnungen in den Schlummermodus zu versetzen, wählen Sie **Alle in den Schlummermodus versetzen für** aus.

    Um eine einzelne Warnung in den Schlummermodus zu versetzen, wählen Sie ![Kebab-Menü](Images/kbt1547502809538.png) > **In den Schlummermodus versetzen für** aus.
