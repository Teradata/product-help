...
1.  [Optional] Verwenden Sie den Abschnitt **Erweiterte Optionen** , um die Menge an [Dauerhafter Speicher](yvc1731523611301.md) und [Zeichensatz](hnk1731523638342.md) für den DBA anzugeben.


1.  [Optional] Wählen Sie **SQL einblenden** aus, um die zugewiesenen Berechtigungen anzuzeigen, bevor der Datenbank-Administratorbenutzer erstellt wird.
