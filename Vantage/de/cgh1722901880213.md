...
1.  Senden Sie mit den Informationen aus diesem Schritt ein Support-Ticket an [https://support.teradata.com](https://support.teradata.com) und fordern Sie die DNS-Adresse und die sekundäre IP-Adresse für das Zielsystem an.
