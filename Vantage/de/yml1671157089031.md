...
1.  Geben Sie in den Anforderungsdetails Folgendes ein: 
    `
 „Zweck: Anforderung zur Erstellung eines privaten Links in VantageCloud Lake für QueryGrid“
 `
...
1.  Geben Sie in den Anforderungsdetails Folgendes ein: 
    `
 „Zweck: Anforderung zur Erstellung eines privaten Links in VantageCloud Enterprise für *Funktionsname*“
 `
