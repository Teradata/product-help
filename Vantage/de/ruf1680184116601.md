...
Vantage erstellt automatisch einen [Umgebungsbereich](jbj1680184191443.md) für den ersten Identitätsanbieter, den Sie konfigurieren. Umgebungsbereich Dies ist der Umgebungsbereich **Standard** . Standard Sie können den Namen jedoch ändern. Sie können zusätzliche Bereiche erstellen.
