...
1.  Legen Sie Eigenschaften auf den Registerkarten **Basis** und **Erweitert** fest.
    ...
    1.  Wählen Sie auf der Registerkarte **Basis** die Optionen **Dataset-Vorlage** und **Dataset** aus und legen Sie die Trainingsvariablen manuell mit vorab bestimmten Werten unter **Hyperparameter** fest, bevor Sie den Trainingsauftrag starten.
    ...
    1.  Geben Sie auf der Registerkarte **Erweitert** die **Docker-Image**-Version und die Details zur **Ressourcenvorlage** ein. Wenn Ihre Umgebung Knoten-Pools verwendet, siehe [Knoten-Pool auswählen](jbj1778560430063.md).
        ...
        -   Legen Sie eine beliebige Auswahl der folgenden Eigenschaften fest:
            ...
            **GPU** (bei Auswahl von **Benutzerdefiniert** angezeigt): Gibt die zugewiesenen GPU-Einheiten für den Container an. Kann eine Ganzzahl oder Dezimalzahl sein. Akzeptiert m als Einheit für Millicores.


1.  Wählen Sie **Modell bewerten** aus.

    **Auftragsdetails bewerten** zeigt die Protokollinformationen an. Sie können den Fortschritt **Beenden** (anhalten).
...
1.  Wählen Sie das Symbol ![Schließen](Images/teg1680569591203.svg) aus, wenn der Bewertungsprozess abgeschlossen ist.
...
**Weiter:** [Modell bereitstellen](zum1732650629250.md).
