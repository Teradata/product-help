...
-   **Schlüsselverwendung**
     ...
     **Verwendung des AWS-Schlüssels** muss sein. 
        `
        encrypt_decrypt
        `
      .
...
-   **Zweck**
     ...
     Ihr KMS-Verschlüsselungsschlüssel in Google Cloud muss mit dem Schlüsselzweck 
        ...
        encrypt_decrypt
        `
       (Verschlüsselung) konfiguriert sein. Weitere Informationen finden Sie in der [Schlüsselzwecke](https://cloud.google.com/kms/docs/algorithms#key_purposes) Dokumentation von Google Cloud.


-   **Schlüsselversion**

    Sie müssen die Schlüsselversion in **Schlüsselressourcenname** angeben und dabei die 
        `
