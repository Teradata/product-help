When you select a deployment to view details, the view is dependent on the deployment type. If a deployment is set to publish only, scheduling is disabled.
