...
-   **Thales**
    ...
    Thales is a software solution that provides key management solutions. The Thales CipherTrust Manager helps maximize security by providing centralized management of keys, policies, and essential functions. See [Thales CipherTrust Database Protection (AWS)](https://www.teradata.com).
