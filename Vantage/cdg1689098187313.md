...
-   Deleting QueryGrid resources is not self-service. Create a change request on [https://support.teradata.com](https://support.teradata.com) to delete QueryGrid services.
