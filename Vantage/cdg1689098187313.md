...
-   VantageCloud Lake on Google supports bi-directional query initiation with VantageCloud Enterprise on Google and VantageCore using the Teradata-to-Teradata connector
