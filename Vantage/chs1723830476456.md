After the primary database administrator (dbadmin) is created by an organization admin, the database administrator can add and remove subsequent DBAs and users to an environment.
