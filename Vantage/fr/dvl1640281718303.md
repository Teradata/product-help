...
-   **Disponibilité**
    ...
    **Suspendre** [**Modifier le profil** uniquement] Suspend un profil. Si vous suspendez un profil actif, les requêtes continuent de s'exécuter jusqu'à la fin du temps de recharge.
