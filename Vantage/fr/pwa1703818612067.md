...
-   **Comparer la DDL**
    ...
    Sélectionnez cette option pour vérifier que les aspects importants de la DDL pour les tables source et cible correspondent avant d'exécuter le plan de copie. La copie de données compare la DDL comme valeur par défaut. **Vrai** définit la comparaison à effectuer avant la copie. **Faux** ne compare pas la DDL avant la copie.
