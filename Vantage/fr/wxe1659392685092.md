...
**Espace permanent** est disponible en fonction des besoins des utilisateurs. Attribuez un espace de stockage permanent aux utilisateurs qui créent ou possèdent des bases de données, des tables et d'autres objets utilisant beaucoup d'espace. Reportez-vous à [Espace permanent](yvc1731523611301.md).

**Jeu de caractères** peut être défini sur le jeu de caractères par défaut ou vous pouvez spécifier Unicode ou Latin pour un utilisateur spécifique. Reportez-vous à [Choisir un jeu de caractères](hnk1731523638342.md).
