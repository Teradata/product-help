...
1.  Renseignez les champs de l'onglet **Publier**, puis sélectionnez **Suivant** :
    ...
    -   Dans l'onglet **Publier**, sélectionnez la connexion d'ensemble de données pour la tâche. Dans **Options avancées**, sélectionnez **Nom du moteur** et **Image de Docker**.
...
1.  Sélectionnez **Déployer**.
    ...
    L'option **Détails du déploiement** affiche les informations sur les journaux de la tâche. Vous pouvez **arrêter** (suspendre) la progression.
