...
-   **Modèle de données sectoriel**
    ...
    Installez les relations de données d'entreprise prédéfinies, les domaines thématiques et les règles métier spécifiques à votre secteur d'activité. Pour des modules Lake+ ou Lake Premium installés par l'administrateur du modèle de données. Reportez-vous à [Modèle de données sectoriel](xum1736387837711.md).
