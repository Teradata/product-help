...
1.  Saisissez ou collez l'instruction SQL ou le script. Vous pouvez également ouvrir un script ![Icône de fichier ouvert](Images/niz1696362597829.svg) existant.
    ...
    **Conseil :** Vous pouvez faire glisser un nom de table à partir du navigateur **Objets** pour l'utiliser dans le script. La connexion aux objets doit être identique à la connexion au script.
...
1.  Si vous avez reçu l'accès à un [groupes de calcul](mqu1640280532737.md), vous pouvez sélectionner celui sur lequel vous souhaitez exécuter votre requête. Si vous ne sélectionnez pas un groupe de calcul, votre requête s'exécute sur le [cluster principal](nmr1658424425362.md).
