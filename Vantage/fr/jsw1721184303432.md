...
1.  Dans le **Comptes sur la liste d'autorisations**, saisissez les ID de comptes **AWS** (avec Direct Connect) pour être autorisé à vous connecter à l'environnement.
