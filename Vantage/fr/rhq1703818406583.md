...
Vérifiez que vous avez fourni les identifiants de base de données corrects. Si le menu reste vide, contactez les services Teradata sur [https://support.teradata.com](https://support.teradata.com).

## Puis-je exporter mes paramètres du gestionnaire de copie avant de désinstaller celui-ci ?


Non. Vous ne pouvez pas exporter les paramètres. Une fois la désinstallation du gestionnaire de copie effectuée sur le système source, les informations sont irrécupérables. Tous les paramètres et toutes les ressources sont supprimés de VantageCloud Lake.

## Comment puis-je planifier l'exécution d'un plan de copie ?


Vous ne pouvez pas planifier l'exécution des plans de copie. Vous pouvez les exécuter manuellement au besoin.
