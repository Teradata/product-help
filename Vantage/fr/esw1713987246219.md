...
1.  Lorsque vous revenez à la page **Détails de la source de données**, remplacez le **Mécanisme d'authentification** par  
    `
    JWT SSO
    `
...
1.  Lorsque vous revenez à la page **Modifier le connecteur**, remplacez le **Mécanisme d'authentification** par  
    `
    JWT SSO
    `
    et sélectionnez un **fournisseur d'identité**.
