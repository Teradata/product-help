...
-   **Zone de disponibilité (AWS uniquement)**
    ...
    Pour améliorer les performances et la rentabilité, vous pouvez sélectionner un **Zone de disponibilité** de votre région dans laquelle d'autres applications sont en cours d'exécution. La sélection de la région la plus proche de votre emplacement physique offre les meilleures performances.
...
-   **Gestion des clés**
    ...
    -   **Géré par Teradata**
        ...
        Il s'agit de l'option par défaut qui assure la prise en charge pour votre clé de chiffrement gérée par la plate-forme.
...
Pour définir les paramètres facultatifs avancés, désactivez **Utiliser les valeurs par défaut**. Lorsque vous utilisez l'option par défaut, les données sont protégées à l'aide des clés de chiffrement gérées par la plate-forme.
