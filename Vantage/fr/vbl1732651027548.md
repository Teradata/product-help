...
L'option **Détails de la version du modèle** répertorie toutes les informations relatives à la version du modèle ainsi qu'aux tâches d'entraînement et d'évaluation. Les détails suivants s'affichent concernant la tâche d'entraînement :

-   **ID de version du modèle**

    Spécifie l'ID de version du modèle. Vous pouvez sélectionner le lien ID de version du modèle pour accéder à la page **Cycle de vie des versions de modèle**.
...
-   **ID d'ensemble de données**
    ...
    Affiche l'ID d'ensemble de données d'entraînement de la tâche. Sélectionnez le lien **ID d'ensemble de données** pour consulter les détails de l'ensemble de données.
...
L'option **Mesures clés** affiche les mesures clés que vous avez marquées dans la zone Mesures qui peut inclure une liste de mesures de performances. Vous pouvez marquer certaines mesures comme **Mesures clés** pour y accéder facilement. Toutes les mesures clés s'affichent dans cette zone.

L'option **Mesures** répertorie les mesures de performances et leurs valeurs pour la version actuelle du modèle, ce qui peut inclure une liste de mesures telles que l'exactitude, le rappel, la précision et le score F1. Utilisez l'option **Marquer comme mesure clé** pour marquer les mesures clés à afficher dans la zone **Mesures clés**. Liste de mesures de performances courantes :
...
-   **Approuvez** la version du modèle.


-   **Refusez** la version du modèle.


-   L'option **Marquer/annuler le marquage comme Champion** marque/annule le marquage de la version du modèle en tant que Champion sur la base de ses performances.


-   L'option **Afficher la dérive du modèle** ouvre la page Dérive du modèle sur laquelle vous pouvez surveiller les performances du modèle.
