...
L'installation d'un modèle de données sectoriel fournit un plan avec des structures (tables et colonnes), ainsi que des définitions et des métadonnées spécifiques au secteur. L'administrateur du modèle de données peut créer les tables et les colonnes entièrement commentées dans la base de données.
