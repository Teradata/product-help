...
Système contenant un ou plusieurs nœuds qui partagent la même plate-forme logicielle (nœuds système Teradata, par exemple).
...
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on AWS (nécessite une demande de modification de PrivateLink)|
|Teradata-to-Teradata|VantageCloud Enterprise on AWS (nécessite une demande de modification de PrivateLink)|
...
|Connecteur|Se connecte à|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on Azure (nécessite une demande de modification de PrivateLink)|
|Teradata-to-Teradata|VantageCloud Enterprise on Azure (nécessite une demande de modification de PrivateLink)|
|Teradata-to-Teradata|VantageCore (sur site)|
...
|Connecteur|Se connecte à|
|----------|------------|
|Teradata-to-Teradata|VantageCloud Lake on Google Cloud (nécessite une demande de modification de Private Service Connect)|
|Teradata-to-Teradata|VantageCloud Enterprise on Google Cloud (nécessite une demande de modification de Private Service Connect)|
|Teradata-to-Teradata|VantageCore (sur site)|
