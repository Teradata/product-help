...
Lorsqu'Anaconda est disponible, les scientifiques des données peuvent télécharger et installer des modules à partir d'un référentiel Python et R sécurisé. Reportez-vous à [Teradata Package for Python on VantageCloud Lake](https://docs.teradata.com/access/sources/dita/topic?dita:topicPath=yoo1705519617505.dita&utm_source=console&utm_medium=iph).
