...
Un [réseau](iwx1674087965329.md) définit les règles qui déterminent les adresses IP utilisées pour la communication de QueryGrid. réseau Vous pouvez définir les règles à l'aide de la notation CIDR (routage interdomaine sans classe) ou en faisant correspondre les noms d'interfaces. Les réseaux sont référencés par des liens et il existe un réseau émetteur et un réseau cible pour chaque tronçon.
