...
|Scénario|Condition requise|
|---------|------------|
|L'utilisateur « JOE » n'existe pas sur le système cible.|Les requêtes doivent être exécutées avec un utilisateur existant sur le système cible, tel que « hive ». Dans ce cas, un mappage d'utilisateurs est nécessaire : l'utilisateur « JOE » du système Teradata est mappé à l'utilisateur « hive » du système Hive.|
|L'utilisateur existe bien sur le système cible sous le nom « joe ».|Un mappage utilisateur est nécessaire lorsque « JOE » sur le système Teradata correspond à « joe » sur le système Hive cible.|
|Existe-t-il sur la cible sous le nom de « JOE » ?|Ce scénario ne nécessite pas de mappage d'utilisateur.|
...
|Options|Description|
|--------|------------|
|Utilisateur sur le système émetteur (par défaut)|L'utilisateur du système Teradata est transmis au système cible en tant qu'utilisateur faisant l'objet de l'emprunt d'identité, le nom d'utilisateur étant entièrement en minuscules.|
|Mappage d'utilisateur|Le mappage d'utilisateur permet de définir l'utilisateur faisant l'objet de l'emprunt d'identité avec un nom d'utilisateur sensible à la casse sur le système cible pour tout utilisateur du système émetteur. Un nom d'utilisateur faisant l'objet de l'emprunt d'identité qui n'est pas entièrement en minuscules constitue un cas d'utilisation typique.|

---

Retour à [Connecter une source de données](znp1640282079399.md)
