Affichez (ou téléchargez sous forme de fichier .csv) le stockage consommé par les environnements de votre organisation VantageCloud Lake pendant la durée d'un contrat.
