...
1.  Créez et vérifiez un **Mot de passe**.

    Lorsque vous créez le mot de passe, suivez les contrôles de mot de passe par défaut du système et la politique du site.


1.  [Facultatif] Utilisez la section **Options avancées** pour spécifier le nombre de [Espace permanent](yvc1731523611301.md) et de [Jeu de caractères](hnk1731523638342.md) pour l'environnement. Les valeurs par défaut système sont appliquées lorsque vous ne saisissez pas de valeurs pour l'espace et les caractères.


1.  [Facultatif] Sélectionnez **Sélectionner SQL** pour afficher les privilèges attribués avant de créer l'utilisateur administrateur de base de données. Il s'agit d'un écran en affichage seul.
