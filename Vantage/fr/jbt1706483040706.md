...
La désinstallation d'un gestionnaire de copie d'un environnement supprime tous les plans et artefacts pour ce dernier. La désinstallation du logiciel de gestionnaire de copie de l'environnement source ne supprime pas le logiciel de l'agent de copie de l'environnement cible.
