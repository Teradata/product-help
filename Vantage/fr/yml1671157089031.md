...
1.  Dans les détails de la demande, saisissez 
    `
 « Objet : demander la création d'un point de terminaison de liaison privée VantageCloud Lake pour QueryGrid »
 `
   et fournissez les informations suivantes :

    -   SiteID VantageCloud Lake.


    -   Nom du service de point de terminaison créé sur le site VantageCloud Lake.


    -   ID de zone de disponibilité dans laquelle le service de point de terminaison a été créé sur le site VantageCloud Lake principal.
...
1.  Dans les détails de la demande, saisissez 
    `
 « Objet : demander la création d'un point de terminaison de liaison privée VantageCloud Enterprise pour *nom de la caractéristique* »
 `
