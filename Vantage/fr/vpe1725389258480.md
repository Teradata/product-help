...
1.  Renseignez les champs suivants :
    ...
    -   Donnez à la connexion d'ensemble un **Nom** et une **Description** significatifs.
    ...
    -   Pour **Identifiants**, spécifiez **Nom d'utilisateur** et **Mot de passe**.


1.  [Facultatif] Sélectionnez **Tester la connexion**.
