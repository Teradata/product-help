...
-   **Compte de service avec objet d'autorisation - DEFINER**
    ...
    Nécessite la création d'un compte de service sur la source de données cible. Les identifiants de connexion sont stockés dans un objet d'autorisation sur le système initiateur dans 
        `
 td_server_db
 `
