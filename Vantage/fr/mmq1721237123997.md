...
1.  [Facultatif] Utilisez la section **Options avancées** pour spécifier le nombre de [Espace permanent](yvc1731523611301.md) et de [Jeu de caractères](hnk1731523638342.md) pour le DBA.


1.  [Facultatif] Sélectionnez **Afficher SQL** pour afficher les privilèges attribués avant de créer l'utilisateur administrateur de base de données.
