...
1.  Dans les détails de la demande, saisissez 
    `
 « Objet : créer un point de terminaison de liaison privée VantageCloud Lake pour la copie de données »
 `
   et fournissez les informations suivantes

    -   SiteID VantageCloud Lake cible
...
1.  Dans les détails de la demande, saisissez 
    `
 « Objet : demander un point de terminaison de liaison privée VantageCloud Enterprise pour la copie de données »
 `
   et fournissez les informations suivantes :
