...
La taille de l'instance d'un cluster principal (taille de chaque nœud) et le nombre d'instances (nombre de nœuds) déterminent ses ressources de calcul. Reportez-vous à [Créer un environnement](qiv1640281527006.md).
