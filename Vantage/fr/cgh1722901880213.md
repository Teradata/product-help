...
1.  Soumettez un ticket d'assistance sur [https://support.teradata.com](https://support.teradata.com) en utilisant les informations de cette étape et demandez l'adresse DNS et l'adresse IP secondaire pour le système cible.
...
1.  Sélectionnez **Démarrer les diagnostics** pour exécuter le test et attendez qu'il soit terminé avant de sélectionner **Suivant**.
...
Pour consulter les options d'autorisation disponibles et décider ce qui convient le mieux à vos environnements, sélectionnez-en **Apprendre** de plus.
