Lorsque vous sélectionnez un déploiement pour afficher les détails, la vue dépend du type de déploiement. Si un déploiement est configuré pour la publication uniquement, la planification est désactivée.
