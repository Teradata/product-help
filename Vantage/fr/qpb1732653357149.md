Lorsque vous sélectionnez un déploiement pour afficher les détails, la vue dépend du type de déploiement. Si ce dernier est défini pour être publié uniquement, la planification est désactivée.
