...
Un point de terminaison de service de liaison privée fournit la connexion entre VantageCloud Lake et un compte AWS ou Azure approuvé. La connectivité multiplateforme n'est pas prise en charge. Utilisez l'une des connexions de liaisons privées suivantes selon votre fournisseur :

-   VantageCloud Lake on AWS se connecte par le biais de PrivateLink à un compte AWS.

-   VantageCloud Lake on Azure se connecte par le biais de PrivateLink à un compte Azure.
