...
1.  Set properties on the **Basic** and **Advanced** tabs.
    ...
    1.  On the **Advanced** tab, specify the **Docker image** version, and the **Resource template** details. If your environment uses node pools, see [Select a Node Pool](jbj1778560430063.md).
