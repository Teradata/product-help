To define a new GIT model in ModelOps, use the tmo command line interface (CLI), available in https://pypi.org/project/teradatamodelops/ or using pip install teradatamodelops command.
