Authorization for data transfers between a source and target can be configured when [connecting a data source](znp1640282079399.md) or when creating a foreign server for a selected data source in the [Links](kzu1674159463068.md) tab.
