...
An account is a logical instance of a database environment. Use an account to load sample data, run queries, view current and historical query data, manage user access, and more. An account consists of the following components:
