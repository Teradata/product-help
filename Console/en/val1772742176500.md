...
The disaster recovery functionality is available only if you purchase DRaaS solution as a separate offering.
...
For self-service disaster recovery, from the **Retained copies** tab, select the snapshot and click **Restore**.

See [Disaster Recovery](https://docs.teradata.com/r/Teradata-VantageCloud-Enterprise/Data-Protection/Disaster-Recovery) for more details.
