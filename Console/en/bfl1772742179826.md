...
-   Describes API capabilities through a strongly
...
-   Allows clients to Request what is needed through
...
The Official GraphQL specification can be found .
...
The VC GraphQL API is secured with Basic Authentication (see ). To make calls to this API (any GraphQL Query or Mutation), will require the following 
    `
    Authorization
    `
   header:
