...
If the job restoration fails or completes with errors, you can rerun the job. Follow these steps:

1.  In the **JOBS** tab, select the failed job.


1.  Select ![](Images/gku1772742368610.svg) to view the details of errors in the OVERVIEW tab.


1.  In the **SETTINGS** tab, make changes in the settings as needed.


1.  Select the objects that failed in the **OBJECTS** tab and click **SAVE**.


1.  Click **RUN** from ![](Images/gku1772742368610.svg).
